    ...
    implements ActionListener
{
   ...
   {
      if((computerMove=='R' && playerMove=='P') || (computerMove=='P' && playerMove=='S') || (computerMove=='S' && playerMove=='R')){
         return -1;
      }
      else if((computerMove=='R' && playerMove=='R') || (computerMove=='P' && playerMove=='P') || (computerMove=='S' && playerMove=='S')){
         return 0;
      }
      else
         return 1;
